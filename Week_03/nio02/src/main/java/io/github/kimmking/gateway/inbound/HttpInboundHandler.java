...
import io.github.kimmking.gateway.outbound.httpclient.LiShiYanHttpOutboundHandler;
...
public class HttpInboundHandler extends ChannelInboundHandlerAdapter {
    ...
    private LiShiYanHttpOutboundHandler handler;
    
    public HttpInboundHandler(String proxyServer) {
        this.proxyServer = proxyServer;
        handler = new LiShiYanHttpOutboundHandler(this.proxyServer);
    }
